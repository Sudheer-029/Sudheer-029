...
| Domain | Technologies |
|---|---|
| **GenAI & Agents** | Azure OpenAI - Amazon Bedrock - Google ADK - Gemini 2.0 - Claude AI |
| **RAG & Vector Search** | LangChain - ChromaDB - Bedrock Knowledge Bases |
| **Cloud** | Microsoft Azure (AZ-900) - AWS - Google Cloud (Vertex AI) |
| **Programming** | Python - SQL |
| **Integrations** | Slack Bolt API - Outlook - Power BI |
...
Automated customer review funnel for local businesses. Smart sentiment routing: 4-5 stars go to Google review, 1-3 stars go to private owner feedback. No app download required.
...
End-to-end automated financial reporting pipeline:

1. Auto-retrieves quarterly earnings PDFs
2. Extracts financial data via Amazon Textract (zero manual entry)
3. Calculates 9 key financial ratios (ROE, EPS, Current Ratio and more)
4. Delivers professional HTML reports to stakeholders via email

Eliminated hours of manual quarterly work. Featured on AWS Builder Center with industry recognition.

---

## Certifications

`Microsoft AZ-900` - `AWS GenAI Learning Plan` - `Prompt Design in Vertex AI` - `Google Gemini Enterprise` - `DeepLearning.AI Prompt Engineering` - `PMI AI in Project Management` - `Google Document AI`
